...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="view"><a href="#" onclick="formSubmit('/cargo/contractAction_toview','_self');this.blur();">查看</a></li>
<li id="new"><a href="#" onclick="formSubmit('/cargo/contractAction_tocreate','_self');this.blur();">新建</a></li>
<li id="update"><a href="#" onclick="formSubmit('/cargo/contractAction_toupdate','_self');this.blur();">修改</a></li>
<li id="delete"><a href="#" onclick="formSubmit('/cargo/contractAction_delete','_self');this.blur();">删除</a></li>
<li id="print"><a href="#" onclick="formSubmit('/cargo/contractAction_print','_self');this.blur();">打印</a></li>
<li id="stat"><a href="#" onclick="formSubmit('/outproduct/outProductAction_toedit','_self');this.blur();">出货表</a></li>
<li id="new"><a href="#" onclick="formSubmit('/cargo/contractAction_submit','_self');this.blur();">上报</a></li>
<li id="new"><a href="#" onclick="formSubmit('/cargo/contractAction_cancelsubmit','_self');this.blur();">取消</a></li>
<li id="back"><a href="#" onclick="formSubmit('/cargo/contractAction_copy','_self');this.blur();">复制</a></li>
...
<input id="btnFind" type="button" name="btnFind" value="查询" onclick="formSubmit('/cargo/contractAction_list','_self');this.blur();">
...
<table id="ec_table"  border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="98%" >
	...
	<tr class="odd"  onmouseover="this.className='highlight'"  onmouseout="this.className='odd'" >
		...
		<td>
			<a href="/cargo/contractProductAction_tocreate?contract.id=${id}">[货物]</a>
		</td>
