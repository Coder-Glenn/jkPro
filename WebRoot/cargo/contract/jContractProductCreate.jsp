...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('/cargo/contractProductAction_save','_self');">确定</a></li>
	...
	<tr>
		...
		<td>
			<input type="button" name="btnAdd" value="删除"
				 onclick="formSubmit('/cargo/contractProductAction_delete?id=${cp.id}','_self');">
			<input type="button" name="btnAdd" value="添加附件"
				 onclick="formSubmit('/cargo/extCproductAction_tocreate?contractProduct.id=${id}&contractProduct.productNo=${cp.productNo}','_self');">
		</td>
	</tr>
</s:iterator>	
</table>
