package cn.graduation.web.struts2.basicinfo.factory;
...
import cn.graduation.entity.Factory;
import cn.graduation.entity.SysCode;
import cn.graduation.entity.dao.FactoryDAO;
...
public class FactoryAction extends _BaseStruts2Action implements ModelDriven<Factory> {
	...
	public String tocreate(){
		FactoryDAO oDao = (FactoryDAO) this.getDao("daoFactory");
		//准备下拉列表
		List<SysCode> ctypeList = oDao.find("from SysCode t where t.parentSysCode.id='0103'");
